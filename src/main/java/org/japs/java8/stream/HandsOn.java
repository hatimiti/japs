...
*/
	...
	public static void problem_0() {
		...
		System.out.println("コメントの「***」部分を適切な関数型インターフェースにして定義してください．");
...
//		***<Product> a = p -> p;
//		***<Product> b = () -> new Product("-", 0, null, null);
//		***<Product, String> c = (Product p) -> p.getName();
//		***<Product> d = p -> System.out.println(p);
//		***<Product> e = p -> 1000 < p.getValue();
//		***<Product, Product> f = (p1, p2) -> p1.equals(p2);
//		***<Product, Product, Boolean> g = (p1, p2) -> p1.equals(p2);
//		***<Product> h = (p1, p2) -> {
...
//		};
//		***<Product> i = p -> p.getValue();
//		***<Product, Product> j = (p1, p2) -> (p1.getValue() + p2.getValue()) / 2.0;
	}
